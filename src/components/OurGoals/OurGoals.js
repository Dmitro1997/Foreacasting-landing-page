...
function OurGoals() {
    return (
        <div className="bg-internatinal-family py-20 text-center">
            <div className="text-[#AE91DF] text-[30px] md:text-[40px] font-bold mb-4">
                Our Goals
            </div>
            <div className="flex justify-center px-10 gap-5 flex-wrap mb-5">
                <div className="white-card p-7 rounded-lg min-w-[200px] sm:min-w-[300px] lg:min-w-[20%] max-w-[20%] border">
                    <div className="rounded-md bg-[#AE91DF] text-white w-7 h-7 self-center text-center mb-4">
